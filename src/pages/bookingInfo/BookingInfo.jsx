    ...
    <>
      {
        <>
          {load ? (
            ...
            <div
              className=" carInfo position-absolute top-50 start-50 translate-middle w-100"
              style={{ height: "100vh" }}
            >
              {updateMode ? (
                <h1 className="header">
                  تعديل <span style={{ color: "#fff842" }}>الحجز</span>
                </h1>
              ) : (
                <h1 className="header">
                  تفاصيل <span style={{ color: "#fff842" }}>الحجز</span>
                </h1>
              )}
              <form
                className=" m-0 position-absolute start-0 row g-3 px-3 w-100"
              ...
              >
                ...
                <div className="col-12 .btns">
                  {updateMode ? (
                    ...
                    <>
                      <Link to="/bookingList" className="btn btn-danger ms-3">
                        رجوع
                      </Link>
                      <div
